...
2. In an `R` script; type one or more functions and hit Ctrl + Enter (Win) or Command + Enter (Mac)
...
- On the previous slide we created a data frame object called `scores`:
